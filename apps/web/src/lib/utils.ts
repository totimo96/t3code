import { CommandId, DesignAssetId, MessageId, ProjectId, ThreadId } from "@t3tools/contracts";
...
export const newDesignAssetId = (): DesignAssetId => DesignAssetId.make(randomUUID());
